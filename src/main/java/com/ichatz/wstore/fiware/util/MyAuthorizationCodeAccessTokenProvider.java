package com.ichatz.wstore.fiware.util;
/*
...
public class MyAuthorizationCodeAccessTokenProvider extends AuthorizationCodeAccessTokenProvider {
    private static Logger LOGGER = LoggerFactory.getLogger(MyAuthorizationCodeAccessTokenProvider.class);
    ...
    public OAuth2AccessToken obtainAccessToken(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
        ...
        String authorizationString = resource.getClientId() + ":" + resource.getClientSecret();

        final String encodedBytes = new BASE64Encoder().encode(authorizationString.getBytes());
        final String authorization = "Basic " + encodedBytes.replaceAll("\n", "");
