...
public class MyOAuth2RestTemplate extends OAuth2RestTemplate {
    private static Logger LOGGER = LoggerFactory.getLogger(MyOAuth2RestTemplate.class);

    private final OAuth2ProtectedResourceDetails resource;

    private AccessTokenProvider accessTokenProvider = new AccessTokenProviderChain(Arrays.<AccessTokenProvider>asList(
            new MyAuthorizationCodeAccessTokenProvider(), new ImplicitAccessTokenProvider(),
